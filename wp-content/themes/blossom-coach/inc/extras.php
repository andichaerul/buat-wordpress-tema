...
function blossom_coach_get_home_sections(){
    ...
    foreach( $sections as $k => $v ){
        if( array_key_exists( 'sidebar', $v ) ){
            ...
            if( get_theme_mod( 'ed_blog_section', true ) ) array_push( $enabled_section, $v['section'] );
            if( get_theme_mod( 'ed_wheeloflife_section', false ) ) array_push( $enabled_section, $v['section'] );
        }
    }
